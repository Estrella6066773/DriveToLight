...
| [回合与行动表](./回合与行动表.md) | **时间如何走**：回合阶段、行动表、指令表、工作时长、环境结算 |
...
| 阶段 | 核心系统参与 |
|------|--------------|
| **玩家指挥** | 移动城市、各队伍：增删改指令表、调整行动表顺序 |
| **玩家行动** | [地图与移动](../01-核心系统/地图与移动.md) 航行；[队伍系统](../01-核心系统/队伍系统.md) 执行任务；[工作中](./回合与行动表.md#工作中状态) 推进完成度 |
| **AI 行动** | [外部城市与组织关系](../01-核心系统/外部城市与组织关系.md) 按种子顺序行动 |
| **环境行动** | 太阳移动、环境效果；驱动 [核心体验与胜利条件](../01-核心系统/核心体验与胜利条件.md) 中的动态难度 |

## 本目录索引

| 名称 | 类型 | 说明 |
|------|------|------|
| [核心循环.md](./核心循环.md) | 文件 | 分钟级 / 小时级 / 长期三级循环与流程图 |
| [回合与行动表.md](./回合与行动表.md) | 文件 | 回合阶段、行动表、指令表、工作效率、环境结算 |
...
| 日期 | 版本 | 说明 |
|------|------|------|
| 2026-06-23 | 0.1.0 | 初稿：两层结构、时间尺度与回合对应、阶段概要 |
