> 状态：评审中
> 校验状态：已对照（与 [01-草稿/归档/系统.md](../01-草稿/归档/系统.md) 同构）
...
> 对外读者请先从 [游戏介绍.md](../游戏介绍.md) 入手；需要全景串联时读 [项目总览.md](../项目总览.md)；本目录各文档为机制专题详解。
...
| 6 | [`06-单位与交战/`](06-单位与交战/) | 队伍、视野、交战结算 | 单位层 |
...
| [`势力系统.md`](05-城市与领袖/势力系统.md) | 外部城市、领袖关系、组织传导 |
...
| [`单位类型与视野.md`](06-单位与交战/单位类型与视野.md) | 侦察/运输/工程单位 |
| [`交战系统.md`](06-单位与交战/交战系统.md) | 交战判定、减员 / 建筑损伤 / 设施耐久结算 |
| [`视野系统.md`](06-单位与交战/视野系统.md) | 侦察塔视野（野外战略设施）、地图情报即时同步（**视野即时同步**；飞信已废止） |
...
| [`探索与扩张.md`](07-玩法循环/探索与扩张.md) | 停泊后的侦察、建设、运输、据点交互 |
...
| 视野 | [`06-单位与交战/视野系统.md`](06-单位与交战/视野系统.md) | [`03-程序设计/03-数据字典/通讯与视野同步数据结构.md`](../03-程序设计/03-数据字典/通讯与视野同步数据结构.md) |
...
| 旧目录 | 状态 | 重定向 |
|--------|------|--------|
| `01-核心系统/` | 已拆分（目录已移除） | 见本页阅读顺序与各域目录 |
