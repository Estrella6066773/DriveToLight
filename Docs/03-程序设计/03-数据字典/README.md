...
| [地形类型配置数据结构](./地形类型配置数据结构.md) | L1 `terrain_defs` 字段 | [L1_terrain/](./tables/L1_terrain/) |
| [设施数据结构](./设施数据结构.md) | L5 `facility_defs`、运行时 | [L5_facility/](./tables/L5_facility/) |
...
| 城区表 | 已并入 L4 | [district_defs.csv](./tables/L4_district/district_defs.csv) |
